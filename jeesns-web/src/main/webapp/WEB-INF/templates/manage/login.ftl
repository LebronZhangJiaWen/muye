...
<head>
    ...
    <title>MUYE后台管理系统登录 - ${SITE_NAME} - Powered By MUYE</title>
...
<div class='login'>
    ...
    <div class='disclaimer'>
        <p>欢迎登陆MUYE后台管理系统 <a href="../">返回首页</a></p>
        <p>Powered By <a href="http://www.silinmuye.com" target="_blank">MUYE</a> CopyRight © 2012-2017</p>
    </div>
</div>
<div class='authent'>
